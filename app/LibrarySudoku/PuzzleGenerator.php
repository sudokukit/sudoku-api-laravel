...
class PuzzleGenerator{
	...
	private $difficulty;
	private $levels = [
			array('level'=>1,'holes'=>30,'bound'=>5),
			array('level'=>2,'holes'=>40,'bound'=>4),
			array('level'=>3,'holes'=>50,'bound'=>3),
			array('level'=>4,'holes'=>60,'bound'=>2),
			array('level'=>5,'holes'=>70,'bound'=>0)];
	private $stack;
	private $sudokuGrid;
	...
	private function populateRandomStack(){
		...
		for ($i=0; $i < $numberOfHoles; $i++) { 
			$this->stack[] = array('x' => rand(0,8), 'y' => rand(0,8));
		}
	}
